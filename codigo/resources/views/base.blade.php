...
<body>
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row default-layout-navbar" >
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center" id="naved">
              <a  class="navbar-brand brand-logo" href="{{route ('dashboard')}}"><img id="im" src="{{asset( 'imagenes/logo1.png')}}" alt="logo"/></a>
              <a  class="navbar-brand brand-logo-mini" href="{{ route('dashboard')}}"><img id="im" src="{{asset( 'imagenes/logo1.png')}}" alt="logo"/></a>
            </div>
            <div class="navbar-menu-wrapper d-flex align-items-stretch" id="naved">
              ...
              <ul class="navbar-nav navbar-nav-right" >
                  ...
                  <li class="nav-item nav-profile dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-right navbar-dropdown"
                          ...
                          <button class="dropdown-item btn" id="cuenta">
                              <i class="fas fa-cog text-primary"></i> Mi Cuenta </button>
                          </a>
                          <div class="dropdown-divider"></div>
                          <button class="dropdown-item btn" id="logout">
                    ...
                    <li class="nav-item nav-profile">
                        <div class="nav-link">
                            ...
                            <div class="profile-name">
                                ...
                                <p class="menu-title" id="tipo-user">
                                    Super Admin
                                </p>
                            </div>
                        </div>
