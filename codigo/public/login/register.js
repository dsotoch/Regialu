...
$(document).on('click', '#register', function (e) {
    ...
    if (dni == "" || nombres == "" || email == "" || password == "") {
        ...
        if (check == false) {
            error("Error,Acepta los Terminos Y Condiciones");
...
$(document).on('click', '#comprar', function (e) {
    ...
    swal({
        ...
        icon: 'warning',
        text: 'Estas a punto de Comprar el Plan ' + licencia,
        buttons: {
            confirmButton: {
                value: true,
                text: "Confirmar",
        ...
        if (value == true) {
            confirmation("Espera Un Momento seras Redirigido a la pagina de Pago");
            $.ajax({
                type: "get",
                url: "/Pagos/payment",
                dataType: "json",
